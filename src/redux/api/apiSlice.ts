...
export const apiSlice = createApi({
  ...
  tagTypes: ["Auth", "Accounts", "Departments", "Employees","Positions","Notifications", "LeaveType", "Roles", "RolePermissions", "Attendance","WorkSchedules","EmployeeShifts","AttendanceReports"],
  endpoints: () => ({}),
});
