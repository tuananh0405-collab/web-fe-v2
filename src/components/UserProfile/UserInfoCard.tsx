      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            {/* Only show Department and Position for non-ADMIN and non-HR_MANAGER roles */}
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  {/* Only show Department and Position fields for non-ADMIN and non-HR_MANAGER roles */}
                  {currentUser.role !== "ADMIN" && currentUser.role !== "HR_MANAGER" && (
                    <>
                      <div className="col-span-2 lg:col-span-1">
